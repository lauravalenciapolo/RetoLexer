...
router.post("/", async (req,res)=>{
    try {
        ...
        const nuevoEmpleado = await crearEmpleado(nif, nombre, apellido1, apellido2,codigo_departamento)
...
router.put("/:codigo", async (req,res)=>{
    try {
        const {nif, nombre, apellido1, apellido2, codigo_departamento} = req.body
        const {codigo} =req.params
        const nuevaInfoEmpleado = await actualizarEmpleado(codigo, nif, nombre, apellido1, apellido2,codigo_departamento)
